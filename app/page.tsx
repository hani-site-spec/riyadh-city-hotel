...
const units = [
  {
    ...
    description:
      "شقة فندقية عائلية فاخرة ومتكاملة، تتميز بصالة معيشة واسعة، وغرفة نوم رئيسية بسرير مزدوج، وغرفة نوم ثانية بسريرين فرديين، إضافة إلى حمام ومطبخ مجهز بجميع الاحتياجات الأساسية، لتوفير إقامة مريحة ومثالية للعائلات.",
    features: ["صالة معيشة واسعة", "سرير مزدوج وسريران فرديان", "مطبخ مجهز"],
  },
  {
    number: "02",
    label: "فئة سوبيريور",
    ...
    description:
      "شقة فندقية عائلية أنيقة ومجهزة بالكامل، تتكون من صالة معيشة مريحة، وغرفة نوم رئيسية بسرير مزدوج، وغرفة نوم ثانية بسريرين فرديين، بالإضافة إلى حمام ومطبخ مجهز، وتناسب العائلات الباحثة عن الراحة والخصوصية ضمن مساحة عملية ومنظمة.",
    features: ["صالة معيشة مريحة", "سرير مزدوج وسريران فرديان", "مساحة عملية ومنظمة"],
  },
];
